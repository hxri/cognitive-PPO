...
def suddenness(current_action):
    # Assuming current_action is a numpy array
    
    # Calculate the differences between consecutive action elements
    diff = np.diff(current_action)
    
    # Calculate the standard deviation of the differences
    suddenness = np.std(diff)
