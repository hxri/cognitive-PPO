...
def register_minigrid_envs():
    ...
    register(
        ...
        entry_point="minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 10, "agent_start_pos": None, "n_obstacles": 5},
    )

    register(
        id="MiniGrid-Dynamic-Obstacles-Random-10x10-v2",
        entry_point="minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 10, "n_obstacles": 5},
    )
    ...
    register(
        ...
        entry_point="minigrid.envs:DynamicObstaclesEnv",
        kwargs={"size": 16, "agent_start_pos": None, "n_obstacles": 7},
    )
